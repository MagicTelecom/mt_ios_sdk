...
The following instructions help you integrate with an existing CocoaPods project.
    ...
    1. Create a folder named MagicTelecomAPI in /path/to/your/project/Vendor/
    2. Extract the contents of the SDK in to the folder named MagicTelecomAPI
    3. Add the following line to your PodFile : 
	       pod 'MagicTelecomAPI', :path => 'Vendor/MagicTelecomAPI'
...
the following.
    ...
    3. A new file named "MagicTelecomAPI.xcworkspace" will be created as a result.
    4. Open the "MagicTelecomAPI.xcworkspace" in XCode 5.0.
